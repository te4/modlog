"""
tends to break with new versions. update like this:
1. download https://github.com/Bukkit/Bukkit/blob/master/src/main/java/org/bukkit/Material.java
2. vim the fuck out of it
3. end up with this file.
"""
materials = {
0: 'AIR',
1: 'STONE',
